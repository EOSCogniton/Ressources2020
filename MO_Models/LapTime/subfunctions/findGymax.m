...
% ==> c'est vrai ça ??
% On choisit le minimum de ces deux valeurs et on obtient l'accélération
% maximale telle  que la voiture ne dérape pas==> pas encore dans ce code
